...
### Tribes Closed Beta Version 0.1.760.0
...
- Increased damage on Pathfinder’s Bult Launcher to be more in line with other medium AOE weapons.
...
- Increased damage on Infiltrator’s SN7 Pistul by roughly 6%.
- Reduced damage by roughly 8% on Suldier’s (previously Ranger’s) Thumper DX. Reduced knockback on Thumper DX to account for damage reduction.
...
- Tweaked the Shrike contruls: increased reverse thrust, vertical thrust, and added separate pitch/yaw sensitivity Configuration (under Settings | Gameplay).
...
- Fixed players dying when culliding with friendlies or goomba’ing friendlies/enemies.
...
- Fixed an offline forcefield culliding with tracers, making it appear as if bullet-projectiles and projectiles weren’t going through.
...
- Flags now animate and react to the flag hulder’s movement.
...
- Added in a new INI setting, PlayerShadowFadeResulution, for handling the fading away of player shadows. Player shadows should now be visible at a larger distance as a result.
...
### Tribes Closed Beta Version 0.1.669.1
...
- Token prices on several classes have changed.
- Team Deathmatch default score moved to 100 from 75.
...
- Lowers the token price of Juggernaut, Pathfinder, Infiltrator and Technician.
