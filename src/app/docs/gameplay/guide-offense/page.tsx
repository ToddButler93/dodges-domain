    ...
    <>
      ...
      <div className="flex max-w-6xl flex-col gap-6 p-6">
        ...
        <Paper className="flex flex-col p-6 shadow-xl">
          <Group className="max-w-4xl">
            <Link href={"/docs/gameplay/guide-quick#glossary"}>Glossary</Link>
            <Text className="">
              Everything you do relies on timing with your <Code>Capper</Code>.
              Since the <Code>Capper</Code> looks to move the enemy flag, your
              goal is to kill everything that can prevent <Code>Capper</Code>{" "}
              from escaping successfully.
            </Text>
            <Text>
              If you hear <Code>E-Grab</Code> you should prioritize
              performing/supporting an <Code>E-Grab</Code> unless your capper
              will beat them.
            </Text>
            <Card>
              ...
              <Text>
                ...
                Generally, only 1 <Code>Offense</Code> member does this, and
                only if you are running 1 <Code>Capper</Code>
              </Text>
              <Text>
            ...
            <Card>
            <Text>
              - <Kbd>K</Kbd>{" "}out and meet your <Code>Capper</Code> after they grab.
            </Text>
            <Text>
        ...
        <Paper className="flex flex-col p-6 shadow-xl">
          ...
          <Text>
            ...
            can get to the stand on time. On most maps, you should be able to
            get to the enemy stand on a <Code>35+ seconds</Code> route
            consistently at the <Code>15 second</Code> time call.
          </Text>
          <Text>
            As long as your fellow <Code>Offense</Code> members hit at the same
            time you should be able to output significant disruption on the
            enemy.
          </Text>
          ...
          <Text>
            This should be done just after your <Code>Capper</Code> dies or
            grabs successfully. Although, if you are in the range of
            killing/distracting the enemy <Code>Sniper</Code> before they can
            output exit damage on your <Code>Capper</Code>, disrupting them
            takes priority.
          </Text>
          <Text>
          ...
          <Text>
            ...
            enemy other than the <Code>Sniper</Code>. It is more beneficial to
            be on time with your team than getting the kill.
          </Text>
          <Text>
            <Code>Defense</Code> can punish <Code>Offense</Code> that linger
            around at the enemy base and forcing them to be out of time with
            their <Code>Capper</Code>.
          </Text>
        </Paper>
        <Divider />
        <Paper className="flex flex-col p-6 shadow-xl">
          ...
          <Text>
            Most of the time you would only walk if your <Code>Capper</Code>{" "}
            dies and the stand is clear enough to get away with a{" "}
            <Code>Walk</Code>. On maps like <Code>Dangerous Crossing</Code>{" "}
            <Code>Walking</Code> when the enemy <Code>HOF</Code> is distracted
            can be effective even when your capper is still 15 seconds out.
          </Text>
          <Text>
            <Code>Walks</Code> shouldn&apos;t be done if your health is low as
            an <Code>Offense</Code> member. <Code>Walking</Code> is useful if
            you have other <Code>Offense</Code> members to help protect or
            promptly meet you. If your fellow <Code>Offense</Code> member is{" "}
            <Code>Walking</Code> the flag it is important to promptly assist in
            getting the flag back to your base. Respawning as a{" "}
            <Code>Light</Code> class to assist with the walk if you are about to
            respawn is optimal.
          </Text>
          <Text>
            Due to the <Code>Rage</Code> mechanic, it is generally better to
            kill the enemy <Code>HOF</Code> and <Code>LD</Code> or{" "}
            <Code>MD</Code> before a walk occurs so they don&apos;t regenerate
            health or energy.
          </Text>
        </Paper>
        <Divider />
        <Paper className="flex flex-col p-6 shadow-xl">
          ...
          <Text>
            ...
            enemy <Code>Capper</Code> moving to your left, you can say
            &apos;Enemy <Code>Capper</Code> is on the left side&apos;. Calling
            out the name of the player is beneficial to assist{" "}
            <Code>Defense</Code> at determining if the enemy is running multiple
            cappers or not.
          </Text>
          <Text>
            This is where learning routes as an <Code>Offense</Code> member can
            be advantageous because you can learn the specifics of recognizable
          ...
          <Text>
            ...
            <Code>Defense</Code>. Allowing your <Code>LD</Code> or{" "}
            <Code>MD</Code> to venture out and kill them before they reach your
            stand, ruining their timing.
          </Text>
        </Paper>
        <Divider />
        <Paper className="flex flex-col p-6 shadow-xl">
          ...
          <Text>
            Killing the enemy <Code>Sniper</Code> before your{" "}
            <Code>Capper</Code> has regenerated their health is an important
            objective pre-flag grab.
          </Text>
          <Text>
          ...
          <Text>
            Killing the enemy <Code>Sniper</Code> before your{" "}
            <Code>Capper</Code> starts a route can prevent them from spotting
            your <Code>Capper</Code> as they start, adding more pressure.
          </Text>
          ...
          <Text>
            ...
            member that knows how to run capping routes. This is generally a
            role dedicated to disrupting the enemy <Code>Sniper</Code>. Two{" "}
          ...
          <Text>
            ...
            <Code>Capper</Code>, as well as disrupt/kill the enemy sniper on
            other runs.
          </Text>
          <Text>
            ...
            against multiple <Code>Cappers</Code>. This works effectively on
            maps that are harder to spot enemy <Code>Cappers</Code> from the
            stand like the map <Code>Katabatic</Code>.
          </Text>
          <Text>
            Another benefit of playing <Code>Flex</Code> is you don&apos;t have
            to always try to grab the flag. You can choose to attack the stand
            or <Code>Sniper</Code> if your route gets spotted early or your
            health regeneration has been shut down for the route.
          </Text>
        </Paper>
        <Divider />
        <Paper className="flex flex-col p-6 shadow-xl">
          ...
          <Text>
            ...
            <Code>Juggernaut</Code>, <Code>Raider</Code> and{" "}
            <Code>Soldier</Code> are the main <Code>GOTY</Code>{" "}
            <Code>Offense</Code> classes.
          </Text>
          <Text>
            Having an explosive or timed weapon and a chain or hitscan weapon is
            optimal for all <Code>Offense</Code> classes.{" "}
            <Code>Juggernauts</Code> can run <Code>Spinfusor Discs</Code> as
            their explosive weapon opening up a <Code>Mortar</Code> and
            chain/hitscan combination.
          </Text>
        </Paper>
      </div>
    </>
