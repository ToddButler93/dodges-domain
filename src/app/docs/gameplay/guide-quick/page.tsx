    ...
    <>
      <div className="flex flex-col gap-6 px-6">
        ...
        <Tabs defaultValue="pugs" className="flex flex-row">
          ...
          <TabsContent value="pugs" className="flex flex-col ps-6 gap-3">
            <h1>Playing PUGs - 7v7 Format</h1>
            <div className="flex flex-col gap-3">
              <p>
                <b>Pick-up Games</b> are a semi-competitive 7v7 format. Pick-up
            ...
            <p>
              ...
              <ul className="list-disc p-3">
                ...
                <li>
                  ...
                  killing your <b>capper</b> pre-grab and post-grab. Generally,
                  only 1 <b>offense</b> member does this only if your team is
                  running 1 <b>capper.</b>
                </li>
                <li>
              ...
              <ul className="list-disc p-3">
                ...
                <li>
                  ...
                  This assists your <b>defense</b> better than you shooting the
                  enemy `offense.
                </li>
                <li>
          ...
          <TabsContent value="defense" className="flex flex-col ps-6 gap-3">
            ...
            <div className="flex flex-col gap-3">
              ...
              <ul className="list-disc p-3">
                ...
                <li>
                  If the enemy <b>capper</b> has recently died, assist any walks
                  your <b>offense</b> may be doing or meet your
                  <b>capper.</b>
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <ul className="list-disc p-3">
                ...
                <li>
                  ...
                  <b>light defense</b> and <b>heavy on flag</b> are fighting or
                  during any walk attempts.
                </li>
              </ul>
              <h3>Minor Responsibilities</h3>
              <ul className="list-disc p-3">
          ...
          <TabsContent value="capping" className="flex flex-col ps-6 gap-3">
            ...
            <ul className="list-disc p-3">
              ...
              <li>
                Communicate times on your route for your <b>offense</b> members.
              </li>
            </ul>
            <h3>Minor Responsibilities</h3>
            <ul className="list-disc p-3">
              <li>
                Meet your <b>offense</b> if they decide to <b>Walk</b> the flag.
              </li>
              <li>
