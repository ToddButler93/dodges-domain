    ...
    <>
      <div className="flex flex-col gap-6">
        <Card className="grow p-6 text-center">
          <h1>Tribes 3: Rivals Quick Competitive Guide</h1>
        </Card>
        <Suspense>
          <Tabs
            defaultValue="home"
          ...
          >
            <TabsList className="flex flex-col items-start justify-start py-1 dark:bg-zinc-800 dark:text-zinc-100">
              ...
              <TabsTrigger value="chasing">Chaser </TabsTrigger>
            ...
            <TabsContent value="home" className="flex flex-col gap-3 ps-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                <p>
                  <b>Defense</b> have two common setups:
                </p>
                <ul className="list-disc p-3">
                  <li>
                    <b>HOF,</b> 1 <b>chase</b> and 1 <b>medium defense.</b>
                  </li>
                  <li>
                    <b>HOF,</b> 2 <b>chase</b>.
                  </li>
                ...
                <p>
                  <b>Offense</b> have two common setups:
                </p>
                <ul className="list-disc p-3">
                  <li>
                    3 <b>offense</b> members and a single <b>capper</b>.
                  </li>
                  <li>
                    2 <b>offense</b> members and dual <b>cappers</b>
                  </li>
                </ul>
                <p>
